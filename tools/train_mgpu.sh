...
# bev2
# python -m torch.distributed.launch --nproc_per_node 2 train.py --launcher pytorch --cfg_file cfgs/kitti_models/CaDDN_DAIR-V2X_kitti_v.yaml --extra_tag epoch_80_gpu_2 --ckpt ../output/kitti_models/CaDDN_DAIR-V2X_kitti_v/epoch_80_gpu_2/ckpt/checkpoint_epoch_39.pth

# bev3
# python -m torch.distributed.launch --nproc_per_node 4 train.py --launcher pytorch --cfg_file cfgs/kitti_models/CaDDN_DAIR-V2X_kitti_v.yaml --extra_tag fp16_e_80_gpu_4_bs_8_lr_E-4 --fix_random_seed --ckpt ../output/kitti_models/CaDDN_DAIR-V2X_kitti_v/fp16_e_80_gpu_4_bs_8_lr_E-4/ckpt/checkpoint_epoch_56.pth


# bev4
# python -m torch.distributed.launch --nproc_per_node 2 train.py --launcher pytorch --cfg_file cfgs/kitti_models/CaDDN_DAIR-V2X_kitti_v.yaml --extra_tag fp16_e_80_gpu_2_bs_4_lr_E-4_SGD --fix_random_seed 
